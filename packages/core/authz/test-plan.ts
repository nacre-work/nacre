...
export const TEST_PLAN: readonly TestCase[] = [
  ...
  { id: 'T21', group: 'delegation', status: 'pending',
    blockedBy: 'delegated authority is not built',
  ...
  // clause.
  { id: 'T22', group: 'delegation', status: 'pending',
    blockedBy: 'delegated authority is not built',
